...
def sampleRequest():
    ...
    brain.processRequest("3", "5853509206")
    ...
    #brain.processRequest("weather location: mountain view ca", "585-350-9206")
    #brain.processRequest("venmo pay: 0.01 to: 3364140402 for: tasty food", "5853509206")
    return render_template("apps.html", user=current_user)
